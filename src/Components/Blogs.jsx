...
const BLOG_DATA = [
  {
    ...
    excerpt:
      "At Krystal Group, Facility management services is an integral aspect of modern business operations, ensuring smooth functioning and optimal utilization of assets. In India, where...",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Krystal Group is one of the most proactive security steps you can take to deter crime is manned guarding, which is a very efficient approach to remove theft and criminal damage...",
    image:
  ...
  {
    id: 3,
    title: "Enhance Security with Kesari Groups...",
    excerpt:
      "Nowadays, Facility Management Services businesses are constantly striving to optimize their operations and maximize productivity. Right from managing facilities to ensuring a co...",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Implementing AI-driven surveillance and automated access control systems is revolutionizing how we perceive corporate safety. Learn how modern tech is reshaping the industry...",
    image:
  ...
  {
    id: 5,
    title: "Sustainable Security Practices for 2025",
    excerpt:
      "Green cleaning is no longer just a trend but a necessity. Discover how eco-friendly products and water-saving techniques are becoming the standard in facility care...",
    image:
      "https://images.unsplash.com/photo-1515344905723-babc01aac23d?q=80&w=1176&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
const BlogCard = ({ post }) => {
  return (
    <div className="bg-[#1B1B1B] rounded-sm p-3 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden h-full flex flex-col transition-transform hover:-translate-y-1 duration-300 border border-[#C9A032]">
      <div className="relative h-48 w-full overflow-hidden group">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#000000]/90 via-[#1B1B1B]/20 to-transparent opacity-0 group-hover:opacity-30 transition-opacity duration-300" />
      </div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-2">
          <button
            className="px-6 py-2 bg-[#C9A032] border transition-colors duration-300 text-sm font-medium hover:bg-[#000000]"
            style={{
    ...
    <div className="min-h-screen bg-white font-sans text-gray-800 relative pb-20">
      <section className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex justify-center">
          <button
            className="px-10 py-3 bg-[#000000] border-2 text-base font-semibold transition-all duration-100 hover:bg-[#C9A032] hover:scale-105"
            style={{
              borderColor: BRAND_COLORS.pink,
              color: "white",
            }}

...
const ITPLLogo = () => (
  ...
  >
    ...
    <text x="0" y="35" fill="#475569" fontFamily="sans-serif" fontSize="5">
...
const AsianPaintsLogo = () => (
  ...
  >
    <path
      d="M10 25C10 15 20 15 20 25C20 35 10 35 10 25Z"
      fill="none"
      stroke="#ef4444"
      strokeWidth="3"
    />
...
const FerringLogo = () => (
  ...
  >
    ...
    <text x="10" y="32" fill="#334155" fontFamily="Arial" fontSize="8">
      PHARMACEUTICALS
    </text>
  </svg>
);
...
const SaharaStarLogo = () => (
  ...
  >
    ...
    <text x="32" y="32" fill="#b45309" fontFamily="cursive" fontSize="10">
      A Step Ahead
    </text>
  </svg>
);
...
const PremierLogo = () => (
  ...
  >
    <path
      d="M10 10C10 5 20 5 20 15C20 25 10 25 10 35"
      stroke="#1d4ed8"
      strokeWidth="4"
      fill="none"
    />
  ...
  return (
    <div className="bg-white flex flex-col items-center justify-center py-10 overflow-hidden font-sans">
      <div className="container mx-auto px-4 mb-20 text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#C9A032] tracking-normal leading-tight max-w-4xl mx-auto">

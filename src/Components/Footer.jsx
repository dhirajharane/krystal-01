...
const FacebookIcon = () => (
  <svg viewBox="0 0 48 48" className="w-8 h-8 rounded-md transition-transform hover:-translate-y-1 cursor-pointer">
...
const InstagramIcon = () => (
  <svg viewBox="0 0 48 48" className="w-8 h-8 rounded-md transition-transform hover:-translate-y-1 cursor-pointer">
    ...
    />
    <path fill="#fff" d="M24 18.5a8 8 0 1 0 0 16 8 8 0 0 0 0-16zm0 12.4a4.4 4.4 0 1 1 0-8.8 4.4 4.4 0 0 1 0 8.8zM34.3 15.6a1.3 1.3 0 1 1-2.6 0 1.3 1.3 0 0 1 2.6 0z" />
  </svg>
);
  ...
  <div className="flex flex-col items-start mb-3">
    <div className="relative w-16 h-14 mb-1">
      <svg viewBox="0 0 100 86" className="w-full h-full drop-shadow-sm">
        ...
        <text x="50" y="68" fontSize="48" fontWeight="900" textAnchor="middle" fill="white" fontFamily="sans-serif">
          K
        </text>
        <text x="85" y="15" fontSize="10" fill="#666">
          ®
        </text>
      </svg>
    </div>
    <div className="text-white font-extrabold text-xl tracking-wide font-sans">KRYSTAL</div>
  </div>
);

export default function Footer() {
  return (
    <footer className="bg-[#005f7f] text-white pt-12 pb-4 px-4 md:px-8 lg:px-16 font-sans">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          <div className="md:col-span-4 flex flex-col items-start">
            <KrystalLogo />
            <p className="text-[15px] leading-relaxed mb-6 font-medium text-white/90 max-w-sm">
              <span className="font-bold text-white">Krystal Integrated Services Ltd</span> – Your trusted partner in
              excellence for facility management, staffing, and beyond.
            </p>
          ...
          <div className="md:col-span-4 pl-0 md:pl-8">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-4 text-[15px]">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <a href="#" className="hover:text-blue-200 transition-colors whitespace-nowrap">
                  Terms & Conditions
                </a>
              </div>
            </div>
            ...
            <div className="space-y-6 text-[15px]">
              <div className="flex items-start">
                ...
                <p className="leading-snug">
                  2001 & 2002, Krystal Integrated Services Ltd, 20th floor, Kohinoor Square, Shivaji Park, Dadar West,
                  Mumbai – 400028.
                </p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@krystal-group.com" className="hover:text-blue-200 transition-colors">
        ...
        <div className="mt-16 text-center text-sm text-white/80">
          <p>© 2025 Krystal Integrated Services Ltd. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );

      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="xl:hidden bg-[#000000] overflow-hidden absolute w-full left-0 shadow-xl border-t border-[#C9A032]"
          >
            <div className="px-4 pt-4 pb-6 space-y-2">
              <MobileNavLink href="#">About Us</MobileNavLink>
              <MobileNavLink href="#" hasDropdown>
                Services
              </MobileNavLink>
              <MobileNavLink href="#" hasDropdown>
                Sectors
              ...
              <div className="pt-6">
                <a
                  href="#"
                  className="block w-full text-center bg-[#1B1B1B] hover:bg-[#C9A032] text-white px-4 py-3 rounded-md font-bold text-lg"
                >
                  Contact Us
                </a>
              </div>
